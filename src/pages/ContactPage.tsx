...
<div className="absolute inset-0 z-0 opacity-20"><img loading="lazy" width="800" height="600" src="https://ik.imagekit.io/xgxpgvop9/truck.jpeg?tr=w-1200,f-auto,q-75" className="w-full h-full object-cover filter brightness-50" /></div>
